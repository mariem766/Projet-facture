...
<div class="container">
            ...
            <form class="row g-3" action="deleteclient.php?id=<?php echo $id;?>" method="post">
                <div class="col-auto">
                    <label for="inputName2" class="visually-hidden">*</label>
                    <input type="text" name= "prenom" class="form-control" id="prenom" placeholder="Prénom" value="<?php echo $donnees['prenom'];?>">
                </div>
                <br>
                <div class="col-auto">
                    <label for="inputEmail2" class="visually-hidden">*</label>
                    <input type="text" name= "nom" class="form-control" id="nom" placeholder="nom" value="<?php echo $donnees['nom'];?>" >
                </div>
                <br>
                <div class="col-auto">
